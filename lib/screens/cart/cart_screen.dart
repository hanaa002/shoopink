  ...
  Widget getCheckoutButton(BuildContext context) {
    return Container(
      ...
      child: AppButton(
        ...
        color: Color.fromARGB(255, 0, 218, 94), // Set the button color to pink
        textColor:
            Color.fromARGB(255, 0, 218, 94), // Set the text color to white
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromARGB(
            255, 0, 218, 94), // Updated background color to white
